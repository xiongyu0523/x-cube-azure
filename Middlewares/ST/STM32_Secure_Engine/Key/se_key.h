...
/**
  ...
  * @param pKey: pointer to an array of uint8_t with the appropriate size (@ref SE_SYMKEY_LEN)
  * @retval void
  */
void SE_ReadKey(uint8_t *pKey);
/**
  * @brief Function to retrieve the public asymmetric key.
  * @param pPubKey: pointer to an array of uint8_t with the appropriate size (@ref SE_ASYM_PUBKEY_LEN)
  * @retval void
  */
