...
/** @defgroup SE_CRYPTO_COMMON_Private_Variables Private Variables
  * @{
  */

/** @defgroup SE_CRYPTO_COMMON_Private_Variables_AES_GCM AES GCM Private Variables
  * @Private variables used for AES GCM symmetric crypto
  * @{
  */
static AESGCMctx_stt m_xSE_AESGCMCtx; /*!<Variable used to store the AES128 context*/
