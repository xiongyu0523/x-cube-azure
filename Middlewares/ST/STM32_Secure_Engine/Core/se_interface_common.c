...
#include "main.h"                       /* se_interface_common.c is compiled in SBSFU project using main.h from this project */
...
/** @defgroup SE_INTERFACE_COMMON_MpuIsolationFunctions SE Interface common functions for MPU Isolation
  *  @brief Functions used by se_interface_bootloader and se_interface_application to handle the MPU isolation of the Secure Engine
  * @{
  */
