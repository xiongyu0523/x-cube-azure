...
/* Includes ------------------------------------------------------------------*/
#include "main.h"                       /* se_interface_application.c is compiled in SBSFU project using main.h from this project */
...
/**
  ...
  */
__root SE_ErrorStatus SE_APP_GetActiveFwInfo(SE_StatusTypeDef *peSE_Status, SE_APP_ActiveFwInfo *p_FwInfo)
{
