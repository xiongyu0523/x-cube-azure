...
/*  Peripheral area mapping without bit banding region  */
...
#define SFU_PROTECT_MPU_PERIPH_2_SREG  0x0
...
/*  F413 1.5 MBytes settings with slot 0  */
...
/* sbsfu and and slot 0 are set Readonly and execution allowed*/
#define APP_PROTECT_MPU_FLASHEXE_SREG  0x82
...
/*  peripheral area is extended to peripheral bit banding */
#define APP_PROTECT_MPU_PERIPH_1_RGNV  MPU_REGION_NUMBER0
#define APP_PROTECT_MPU_PERIPH_1_START PERIPH_BASE
#define APP_PROTECT_MPU_PERIPH_1_SIZE  MPU_REGION_SIZE_512MB  /* JMG */ 
#define APP_PROTECT_MPU_PERIPH_1_SREG  0x0
...
/*  bit banding area for dma is un mapped header area is used for that */
...
#define APP_PROTECT_MPU_DMABBA_SREG  0x0
...
/* header is disabled before launching application */
...
#define SFU_PROTECT_MPU_SRAMACC_START SRAM1_BASE
#define SFU_PROTECT_MPU_SRAMACC_SIZE  MPU_REGION_SIZE_512KB
#define SFU_PROTECT_MPU_SRAMACC_SREG  0xe0
...
#define SFU_CALLBACK_Antitamper(void) HAL_RTCEx_Tamper1EventCallback(RTC_HandleTypeDef *hrtc) /*!<SFU Redirect of RTC Tamper Event Callback*/
