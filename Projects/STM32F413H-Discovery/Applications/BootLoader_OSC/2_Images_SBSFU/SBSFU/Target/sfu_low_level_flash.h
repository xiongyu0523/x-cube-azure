...
/* STM32F4: The write access type (byte, half-word, word or double word) must correspond to the type of parallelism chosen (x8, x16, x32 or x64) */
...
#define IS_ALIGNED(address) (address == FlashSectorsAddress[SFU_LL_FLASH_GetSector(address)])
