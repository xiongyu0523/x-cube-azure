...
ProtectionTest_t aProtectTests[] =
{
  ...
  {(uint32_t)0x1FFFC018, "OBs @ 0x1FFFC018", TEST_WRITE_FLASH}, /* Due to MPU definition, we protect 32B instead of 16B */
#endif /* SFU_MPU_PROTECT_ENABLE  */
...
static void SFU_TEST_Protection(void)
{
  ...
  do
  {
    ...
    TRACE("\r\n= [TEST] %s @ %s %08x", aTestOperation[aProtectTests[test_idx].type], aProtectTests[test_idx].msg, aProtectTests[test_idx].address);
