...
The application supports the STM32F769I-Discovery board and connects to the Internet through the on-board or attached
network interface.
...
@par Hardware and Software environment
  ...
  - Ethernet router.
      * With a transparent IPv4 Internet connectivity: No proxy, no firewall blocking the outgoing traffic.
...
@Par Target-specific notes
  ...
  * The MAC address of the Ethernet interface is derived from the unique CPU ID thanks to a SHA256 hash, imported from mbedTLS.
